...
# se re-extrait a chaque premier lancement (~15 s sans retour visible depuis le
# menu Demarrer). Un dossier de fichiers demarre instantanement.
Write-Host "==> Publication backend ($Rid, autonome)"
...
# Renomme l'executable hote en "EbiosRM" (l'apphost, independant du nom d'assembly).
if ($Rid -like "win-*") {
